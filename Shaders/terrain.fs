...
vec3 calculateDirectionalLight(Light light, vec3 direction){
	...
	float cantidadColorBlenMap = 1-(blendMapColor.r + blendMapColor.g + blendMapColor.b);
	vec4 colorTextureBackground = texture(backgroundTexture, tiledCoords) * cantidadColorBlenMap;
